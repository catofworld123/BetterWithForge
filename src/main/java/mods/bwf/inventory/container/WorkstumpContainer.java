package mods.bwf.inventory.container;
...
public class WorkstumpContainer extends Container
{
    ...
    public WorkstumpContainer(InventoryPlayer p_i1808_1_, World p_i1808_2_, int p_i1808_3_, int p_i1808_4_, int p_i1808_5_)
    {
