...
public class BTWEffectManager {
    ...
    public static void initEffects() {
        ...
        EffectHandler.effectMap.put(NETHER_GROTH_SPORES_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, BTWSoundManager.SOUL_SCREAM.sound(), 4.0F, world.rand.nextFloat() * 0.4F + 0.8F,false);
        ...
        EffectHandler.effectMap.put(FIRE_FIZZ_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "random.fizz", fizzVolume, fizzPitch,false);
        });
        ...
        EffectHandler.effectMap.put(WOLF_HURT_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.wolf.hurt", 0.4F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false)
        );

        EffectHandler.effectMap.put(CHICKEN_HURT_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.chicken.hurt", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false)
        );
        ...
        EffectHandler.effectMap.put(COMPANION_CUBE_DEATH_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            for( int tempCount = 0; tempCount < 7; tempCount++)
            {
                ...
                world.spawnParticle( s,
                    ((double) x) + (double)(world.rand.nextFloat()),
                    (double)( y + 1 ) + (double)(world.rand.nextFloat()),
                    ((double) z) + (double)(world.rand.nextFloat()),
                    d, d1, d2);
            }
            world.playSound(x, y, z, "mob.wolf.whine", 0.5F, 2.6F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.8F,false);
        });

        EffectHandler.effectMap.put(POSSESSED_CHICKEN_EXPLOSION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "random.explode", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false);
            world.playSound(x, y, z, "mob.chicken.hurt", 2.0F, world.rand.nextFloat() * 0.4F + 1.2F,false);
        ...
        EffectHandler.effectMap.put(ENDERMAN_COLLECT_BLOCK_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            if (block != null) {
                world.playSound(x, y, z, block.stepSound.getBreakSound(), (block.stepSound.getVolume() + 1.0F) / 2.0F, block.stepSound.getPitch() * 0.8F,false);
                mcInstance.effectRenderer.addBlockDestroyEffects((int) x, (int) y, (int) z, Block.getBlockById(blockID), metadata);
            }
        });
        ...
        EffectHandler.effectMap.put(ENDERMAN_CONVERT_BLOCK_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.endermen.portal", 1.0F, 1.0F,false);
        });
        ...
        EffectHandler.effectMap.put(ENDERMAN_PLACE_BLOCK_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.endermen.hit", 1.0F, 1.0F,false);
        });
        ...
        EffectHandler.effectMap.put(ENDERMAN_CHANGE_DIMENSION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "ambient.weather.thunder", 3.0F, world.rand.nextFloat() * 0.4F + 0.8F,false);
        });
        ...
        EffectHandler.effectMap.put(SOUL_URN_SHATTER_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "random.glass", 1.0F, 1.2F / (world.rand.nextFloat() * 0.2F + 0.9F),false);
            world.playSound(x, y, z, "mob.ghast.scream", 0.2F, world.rand.nextFloat() * 0.2F + 0.5F,false);
        ...
        EffectHandler.effectMap.put(COW_REGEN_MILK_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.slime.attack", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 0.6F,false)
        );
        ...
        EffectHandler.effectMap.put(COW_CONVERSION_TO_MOOSHROOM_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.cow.hurt", 1.0F, hurtPitch,false);
        });
        ...
        EffectHandler.effectMap.put(WOLF_HOWL_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.wolf.howl", soundVolume, soundPitch,false);
        });

        EffectHandler.effectMap.put(WOLF_CONVERSION_TO_DIRE_WOLF_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.spawnParticle("largeexplode", x, y, z, 0.0D, 0.0D, 0.0D);
            world.playSound(x, y, z, "mob.slime.attack", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false);
            world.playSound(x, y, z, "mob.wolf.growl", 8.5F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.05F + 0.55F,false);
        });

        EffectHandler.effectMap.put(CREEPER_SNIP_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.sheep.shear", 1.0F, 1.0F,false);
            world.playSound(x, y, z, "mob.slime.attack", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.1F + 0.7F,false);
        ...
        EffectHandler.effectMap.put(POSSESSED_PIG_TRANSFORMATION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.pig.death", 2.0F, world.rand.nextFloat() * 0.4F + 1.2F,false);
            world.playSound(x, y, z, "mob.zombiepig.zpigangry", 2.0F, ((world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F) * 1.8F,false);
            world.playSound(x, y, z, "mob.slime.attack", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false);
            world.spawnParticle("largeexplode", x, y, z, 0.0D, 0.0D, 0.0D);
        ...
        EffectHandler.effectMap.put(POSSESSED_VILLAGER_TRANSFORMATION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "ambient.weather.thunder", 3.0F, world.rand.nextFloat() * 0.4F + 0.8F,false);
            world.playSound(x, y, z, "mob.ghast.affectionate scream", 2.0F, 0.5F + world.rand.nextFloat() * 0.25F,false);
            world.spawnParticle("largeexplode", x, y, z, 0.0D, 0.0D, 0.0D);
        ...
        EffectHandler.effectMap.put(SHEEP_REGROW_WOOL_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "step.cloth", 1.0F, world.rand.nextFloat() * 0.1F + 0.9F,false)
        );
        ...
        EffectHandler.effectMap.put(CREATE_SNOW_GOLEM_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "random.glass", 1.0F, 1.2F / (world.rand.nextFloat() * 0.2F + 0.9F),false);
            world.playSound(x, y, z, "mob.enderdragon.growl", 0.25F, world.rand.nextFloat() * 0.2F + 1.8F,false);
        ...
        EffectHandler.effectMap.put(CREATE_IRON_GOLEM_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "random.glass", 1.0F, 1.2F / (world.rand.nextFloat() * 0.2F + 0.9F),false);
            world.playSound(x, y, z, "mob.irongolem.death", 1.0F, world.rand.nextFloat() * 0.2F + 0.5F,false);
            world.playSound(x, y, z, "mob.enderdragon.growl", 0.5F, world.rand.nextFloat() * 0.2F + 1.5F,false);
        ...
        EffectHandler.effectMap.put(TOSS_THE_MILK_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.slime.attack", 0.5F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.1F + 0.6F,false);
            world.playSound(x, y, z, "random.classic_hurt", 0.25F, soundPitch,false);
        });

        EffectHandler.effectMap.put(APPLY_DUNG_TO_WOLF_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.wolf.whine", 0.5F, 1.5F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.4F,false);
            ...
            world.playSound(x, y, z, "mob.slime.attack", 0.5F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.1F + 0.8F,false);
        });

        EffectHandler.effectMap.put(POSSESSED_SQUID_TRANSFORMATION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.slime.attack", 1F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1.0F,false);
            world.playSound(x, y, z, "mob.ghast.scream", 10F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 1F,false);
        ...
        EffectHandler.effectMap.put(APPLY_MORTAR_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.slime.attack", 0.70F + world.rand.nextFloat() * 0.1F, 0.85F + world.rand.nextFloat() * 0.1F,false)
        );

        EffectHandler.effectMap.put(LOOSE_BLOCK_STUCK_TO_MORTAR_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.slime.attack", 0.15F + world.rand.nextFloat() * 0.1F, 0.6F + world.rand.nextFloat() * 0.1F,false)
        );

        EffectHandler.effectMap.put(SMOLDERING_LOG_FALL_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.zombie.woodbreak", 1.25F, 0.5F + world.rand.nextFloat() * 0.1F,false);
            world.playSound(x, y, z, "mob.ghast.fireball", 1F, 0.5F + world.rand.nextFloat() * 0.1F,false);
        });

        EffectHandler.effectMap.put(SMOLDERING_LOG_EXPLOSION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "mob.zombie.wood", 1.25F, 0.5F + world.rand.nextFloat() * 0.1F,false);
        ...
        EffectHandler.effectMap.put(WATER_EVAPORATION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "random.fizz", 0.5F, 2.6F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.8F,false);
        ...
        EffectHandler.effectMap.put(CREATE_WITHER_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "random.glass", 1.0F, 1.2F / (world.rand.nextFloat() * 0.2F + 0.9F),false);
            world.playSound(x, y, z, "mob.wither.death", 1.0F, world.rand.nextFloat() * 0.2F + 0.5F,false);
            world.playSound(x, y, z, "mob.enderdragon.growl", 0.5F, world.rand.nextFloat() * 0.2F + 1.5F,false);
        ...
        EffectHandler.effectMap.put(LIGHTNING_STRIKE_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.spawnParticle("largeexplode", x, y, z, 0D, 0D, 0D);
            world.playSound(x, y, z, "random.explode", 4F, 0.5F + world.rand.nextFloat() * 0.2F,false);
            world.playSound(x, y, z, "ambient.weather.thunder", 10000F, 0.8F + world.rand.nextFloat() * 0.2F,false);
        });

        EffectHandler.effectMap.put(FLAMING_NETHERRACK_FALL_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.ghast.fireball", 0.1F, 0.75F + world.rand.nextFloat() * 0.1F,false)
        );
        ...
        EffectHandler.effectMap.put(ANIMAL_EATING_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, "random.eat", 0.75F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 0.6F,false);
        ...
        EffectHandler.effectMap.put(FAILED_EATING_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "random.burp", 0.25F, world.rand.nextFloat() * 0.3F + 1F,false)
        );

        EffectHandler.effectMap.put(SOUL_SPREAD_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.SOUL_SPREAD.sound(), 1F, 1F - world.rand.nextFloat() * 0.2F,false)
        );

        EffectHandler.effectMap.put(POSSESSION_COMPLETE_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.SOUL_POSSESSION_COMPLETE.sound(), 1F, 1F - world.rand.nextFloat() * 0.2F,false)
        );

        EffectHandler.effectMap.put(INFUSION_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.VILLAGER_PRIEST_INFUSE.sound(), 2F, 1F - world.rand.nextFloat() * 0.2F,false)
        );

        EffectHandler.effectMap.put(GLOOM_BITES_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.GLOOM_BITES.sound(), 3F, 0.9F + world.rand.nextFloat() * 0.1F,false)
        );
    }
    ...
    private static void initBlockEffects() {
        ...
        EffectHandler.effectMap.put(LOG_STRIP_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.CHISEL_WOOD.sound(), 1F, 0.8F + world.rand.nextFloat() * 0.1F,false)
        );

        EffectHandler.effectMap.put(SHAFT_RIPPED_OFF_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            world.playSound(x, y, z, BTWSoundManager.CHISEL_STONE.sound(), 0.25F, 1.1F + world.rand.nextFloat() * 0.1F,false);
            world.playSound(x, y, z, BTWSoundManager.CHISEL_WOOD.sound(), 1.5F, 0.5F + world.rand.nextFloat() * 0.1F,false);
        });
        ...
        EffectHandler.effectMap.put(STONE_RIPPED_OFF_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, BTWSoundManager.ORE_BREAK.sound(), 2.0F, 0.9F,false);
        });
        ...
        EffectHandler.effectMap.put(GRAVEL_RIPPED_OFF_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, BTWSoundManager.CHISEL_STONE.sound(), 0.5F, 1.1F + world.rand.nextFloat() * 0.1F,false);
            world.playSound(x, y, z, "step.gravel", 1F, world.rand.nextFloat() * 0.25F + 1F,false);
        });

        EffectHandler.effectMap.put(WOOD_BLOCK_DESTROYED_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.zombie.woodbreak", 0.25F, 1.0F + (world.rand.nextFloat() * 0.25F),false)
        );

        EffectHandler.effectMap.put(DIRT_TILLING_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, BTWSoundManager.HOE_TILL.sound(), 1.0F, 1.0F,false)
        );

        EffectHandler.effectMap.put(IRON_DOOR_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            if (data == 0) {
                world.playSound(x, y, z, BTWSoundManager.IRON_DOOR_CLOSE.sound(), 1.0F, 1.0F,false);
            }
            else {
                world.playSound(x, y, z, BTWSoundManager.IRON_DOOR_OPEN.sound(), 1.0F, 1.0F,false);
            }
        });
        ...
        EffectHandler.effectMap.put(BLOCK_DESTROYED_WITH_IMPROPER_TOOL_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            if (block != null) {
                ...
                if (block.getMaterial() == BWFRegistry.plankMaterial || block.getMaterial() == BWFRegistry.logMaterial) {
                    world.playSound(x, y, z, "mob.zombie.woodbreak", 0.25F, 1.0F + (world.rand.nextFloat() * 0.25F),false);
                } else if (block.getMaterial() == Material.anvil) {
                    world.playSound(x, y, z, "random.anvil_land", 1F, world.rand.nextFloat() * 0.25F + 0.75F,false);
                }
            }
        });
        ...
        EffectHandler.effectMap.put(MELON_EXPLODE_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            world.playSound(x, y, z, "mob.zombie.wood", 0.2F, 0.60F + (world.rand.nextFloat() * 0.25F),false);
            world.playSound(x, y, z, "mob.slime.attack", 1.0F, (world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F + 0.6F,false);
        });

        EffectHandler.effectMap.put(PUMPKIN_EXPLODE_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            String particle = "iconcrack_" + 22502;
        ...
        EffectHandler.effectMap.put(GOURD_IMPACT_SOUND_EFFECT_ID, (mcInstance, world, player, x, y, z, data) ->
            world.playSound(x, y, z, "mob.zombie.wood", 0.1F, 0.40F + (world.rand.nextFloat() * 0.25F),false)
        );
        ...
        EffectHandler.effectMap.put(BLOCK_CONVERT_EFFECT_ID, (mcInstance, world, player, x, y, z, data) -> {
            ...
            if (blockID > 0)
            {
                ...
                if (blockadd.shouldPlayStandardConvertSound(world, (int) x, (int) y, (int) z)) {
                    Block.SoundType stepSound = block.stepSound;
                    world.playSound( (float) z + 0.5F, (float) x + 0.5F, (float) y + 0.5F, stepSound.getBreakSound(),
                        (stepSound.getVolume() + 1.0F) / 2.0F, stepSound.getPitch() * 0.8F, false);
                }
            }

            mcInstance.effectRenderer.addBlockDestroyEffects(x, y, z,
                Block.getBlockById(data & 4095), data >> 12 & 255);
        });
